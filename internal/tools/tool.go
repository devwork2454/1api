...
type Tool struct {
	...
	// AfterLiveChange runs after a profile restore mutates live files (switch/undo).
	// Used for companion configs that aren't snapshotted (e.g. oh-my-openagent).
	AfterLiveChange  func() error
